...
export default function AiAssistant() {
  ...
  return (
    <div className="pb-8 h-[calc(100vh-64px)] lg:h-auto flex flex-col">
      ...
      <div className="p-4 lg:p-0 max-w-2xl flex-1 flex flex-col">
        ...
        {activeTab === 'chat' ? (
          <>
            ...
            {/* Input */}
            <div className="flex items-center gap-2 bg-neutral-0 border border-neutral-200 rounded-xl px-3 py-2">
              <input
                type="text"
                value={input}
