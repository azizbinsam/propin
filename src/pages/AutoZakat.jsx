    ...
    <div className="pb-8">
      ...
      <div className="p-4 lg:p-0">
        ...
        <div className="space-y-4 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-6 lg:items-start">
          {/* Kolom kiri: status, estimasi, info haul */}
          ...
          {/* Kolom kanan: mitra penyaluran & riwayat */}
          <div className="space-y-4">
            <Card variant="flat">
              <div className="flex items-center gap-2 mb-2">
                <span className="w-8 h-8 rounded-full bg-green-50 flex items-center justify-center text-green-700 text-xs font-bold shrink-0">
                  B
                </span>
                <div>
