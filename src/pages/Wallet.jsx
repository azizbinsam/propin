    ...
    <div className="space-y-6 pb-20 md:pb-8">
      ...
      <div className="card">
        <div className="flex justify-between items-center">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <code className="text-sm font-mono bg-neutral-100 px-3 py-1 rounded-lg">{wallet?.address || '0x000...'}</code>
        ...
        <div className="mt-4 p-4 bg-neutral-50 rounded-xl">
          ...
          <p className="text-sm text-neutral-500">{ownedTokens?.reduce((sum, t) => sum + (t.tokens || 0), 0) || 0} token</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        {ownedTokens && ownedTokens.length > 0 ? (
          ownedTokens.map((token) => (
            <div key={token.id || token.propertyId} className="card flex justify-between items-center">
              <div>
